...
(function($) {
	...
	DateTimePicker.prototype = {
		...
		init: function(element, options) {
			...
			if (this.$element.find(".input-append") || this.$element.find(".input-prepend")) {
				...
				console.log("THIS:COMPONENT? at initialize time: ", this.component);
			} else {
			...
			this._compileFormat();
			if (this.component) {
				console.log("THIS:COMPONENT?. ", this.component ? "true" : "false");
		...
		place: function() {
			...
			console.log("THIS.ELEMENT.OFFSET: ", this.$element.offset());
		...
		fillMinutes: function() {
			...
			for (var rows = 0; rows < 4; rows++) {
				html += "<tr>";
				for (var columns = 0; columns < 3; columns += 1) {
					var c = current.toString();
		...
		actions: {
			...
			selectHour: function(e) {
				...
				if (value.toString().length > 2 || value.toString().length < 1) { this.actions.showPicker.call(this)}
				if (this.options.pick12HourFormat) {
	...
	function getTemplate(timeIcon, pickDate, pickTime, is12Hours, showSeconds, collapse) {
		if (pickDate && pickTime) {
			return '<div class="datetimepicker dropdown-menu">' + "<ul>" + "<li" + (collapse ? ' class="collapse in"' : "") + ">" + '<div class="datepicker">' + DPGlobal.template + "</div>" + "</li>" + '<li class="picker-switch accordion-toggle"><a><i class="' + timeIcon + '"></i></a></li>' + "<li" + (collapse ? ' class="collapse"' : "") + ">" + '<div class="timepicker">' + TPGlobal.getTemplate(is12Hours, showSeconds) + "</div>" + "</li>" + "</ul>" + "</div>"
		} else if (pickTime) {
			return '<div class="datetimepicker dropdown-menu">' + '<div class="timepicker">' + TPGlobal.getTemplate(is12Hours, showSeconds) + "</div>" + "</div>"
		} else {
			return '<div class="datetimepicker dropdown-menu">' + '<div class="datepicker">' + DPGlobal.template + "</div>" + "</div>"
		}
	}
	function UTCDate() {
